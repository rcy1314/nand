var visual = function(n) {
  ...
  if (op == 1) {
    $('html body #wrapper #container, ' + 'html body #wrapper #container #guide .blur, ' +
      'html body #wrapper #container #main, ' + 'html body #wrapper #container #main #top, ' +
      'html body #wrapper #container #main #top #arm, ' + 'html body #wrapper #container #main #visit, ' +
    ...
    $(
      'html body #wrapper #container #guide, ' + 'html body #wrapper #container #main #top, ' +
    ...
    $('html body #wrapper #container #main #top #arm #search #home, .fas, .images, a').css('color','#fff')
    ...
    $('html body #wrapper #container, ' + 'html body #wrapper #container #main #top, ' +
      'html body #wrapper #container #main .group, ' + 'html body #wrapper #container #main #top #arm, ' +
      'html body #wrapper #container #main #notification, ' +
      'html body #wrapper #container #main #top #arm #option, ' +
      'html body #wrapper #container #main #visit .page #front #first .listing .index, ' +
      'html body #wrapper #container #main #top #arm #search #match .listing .index, ' +
    ...
    $('html body #wrapper #container #main, ' + 'html body #wrapper #container #main #visit, ' +
