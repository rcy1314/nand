...
var translationBuild = function(translation) {
  return (
    ...
    translation +
    "'>" +
    "  <img class='quickTranslation' src='images/" +
    translation +
    ".webp'> " +
    "  <a class='query' ext='" +
...
var assetBuild = function (assetIndex, assetImage, assetId) {
  return (
    "<div class='asset' aria-item='" +
    assetIndex +
    "'>" +
    "  <img class='entity' src='" +
    assetImage +
    "' " +
    "'> " +
    "  <a class='query' title='" +
